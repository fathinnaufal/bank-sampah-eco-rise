...
<head>
  ...
  <link rel="shortcut icon" href="asset\internal\img\img-local\logo ecorise.png">
...
<div class="page-wrap">
  <div class="header">
    <div class="box-1">
      <h1 id="title">Bank Sampah Eco-Rise</h1>
      <p id="title"> Merubah sampah menjadi penghasilan tambahan Anda !!! </p>
      <br> <br>
    ...
    <section class="team">
      <div class="container">
        <div class="row">
          ...
          <p>Lorem ipsum, dolor sit amet consectetur adipisicing elit. Molestias optio itaque veniam? Eaque eius excepturi fuga quae consequuntur, similique inventore fugiat recusandae. Pariatur voluptatibus expedita veniam nihil quod aliquam quidem..</p>
        </div>
  ...
  <div id="bar">
    <div class="row mgt50px">
      ...
      <br>
      <br>
      <iframe src="" width="1362" height="470" frameborder="0" style="margin-bottom: 0; left: 10px;" allowfullscreen></iframe>
    </div>
  </div>
  ...
  <footer class="footer-distributed">
    ...
    <div class="footer-center">
      ...
      <div>
        ...
        <p><span>Desa</span> Kecamatan , Kabupaten .</p>
      </div>

      <div>
        <i class="fa fa-phone"></i>
        <p><a href="#">+62 1234567890</a></p>
      </div>

      <div>
        <i class="fa fa-envelope"></i>
        <p><a href="#">ecorise@gmail.com</a></p>
      </div>
